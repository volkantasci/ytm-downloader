...
def main(artist_url, artist_name, limit, song_limit, dry_run):
    """
    ...
    download_artist_albums(artist_url, artist_name, limit=limit, song_limit=song_limit, dry_run=dry_run)
