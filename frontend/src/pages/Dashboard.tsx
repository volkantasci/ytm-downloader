    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-6xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                ...
                <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6 shadow-xl hover:border-blue-500/30 transition-colors">
                    ...
                    <form onSubmit={handleSearchDownload} className="space-y-4">
                        <div>
                ...
                <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6 shadow-xl hover:border-purple-500/30 transition-colors">
                    <div className="flex items-center gap-3 mb-6">
                    ...
                    <form onSubmit={handleArtistDownload} className="space-y-4">
